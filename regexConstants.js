...
exports.massEmailRegexList = [/release email/i, /release message/i, /groups.reed.edu admins: Message Pending/, /mass email/i, /approve(.*)Newsletter/i, /message(.*)release/i, /released/i, /approve email/i, /approve the email/i, /approved the email/i, /release this message/i];
