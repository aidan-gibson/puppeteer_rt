...
export const hardwareRegexList = [/iMac/, /hardware store/i]
...
export const massEmailRegexList = [/release email/i, /release message/i, /groups.reed.edu admins: Message Pending/, /mass email/i, /approve(.*)Newsletter/i, /message(.*)release/i, /released/i]
